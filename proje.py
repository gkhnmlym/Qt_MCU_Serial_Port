...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(556, 375)
        MainWindow.setMinimumSize(QtCore.QSize(556, 375))
        MainWindow.setMaximumSize(QtCore.QSize(556, 375))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("qrc/indir (1).jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.frame.setGeometry(QtCore.QRect(10, 70, 191, 191))
        font = QtGui.QFont()
        ...
        self.portseciniz.setStyleSheet("")
        ...
        self.pb_cikis.setGeometry(QtCore.QRect(410, 190, 121, 61))
        font = QtGui.QFont()
...
"  background: #064570;\n"
"  background-image: -webkit-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: -moz-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: -ms-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: -o-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: linear-gradient(to bottom, #064570, #68b6e6);\n"
"  -webkit-border-radius: 21;\n"
"  -moz-border-radius: 21;\n"
"  border-radius: 21px;\n"
"  text-shadow: 6px 5px 3px #7a797a;\n"
...
"  border: solid #f20c0c 1px;\n"
"  text-decoration: none;\n"
"}\n"
"\n"
"QPushButton:hover {\n"
"  background: #fc2424;\n"
"  background-image: -webkit-linear-gradient(top, #fc2424, #f70f0f);\n"
"  background-image: -moz-linear-gradient(top, #fc2424, #f70f0f);\n"
"  background-image: -ms-linear-gradient(top, #fc2424, #f70f0f);\n"
"  background-image: -o-linear-gradient(top, #fc2424, #f70f0f);\n"
"  background-image: linear-gradient(to bottom, #fc2424, #f70f0f);\n"
"  text-decoration: none;\n"
"}")
        self.pb_cikis.setObjectName("pb_cikis")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(220, 70, 181, 191))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.seriPort = QtWidgets.QLabel(self.groupBox)
        self.seriPort.setGeometry(QtCore.QRect(30, 60, 121, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.seriPort.sizePolicy().hasHeightForWidth())
        self.seriPort.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.seriPort.setFont(font)
        self.seriPort.setStyleSheet("")
        self.seriPort.setText("")
        self.seriPort.setAlignment(QtCore.Qt.AlignCenter)
        self.seriPort.setObjectName("seriPort")
        self.lblVolt = QtWidgets.QLabel(self.groupBox)
        self.lblVolt.setGeometry(QtCore.QRect(40, 130, 101, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblVolt.sizePolicy().hasHeightForWidth())
        self.lblVolt.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lblVolt.setFont(font)
        self.lblVolt.setStyleSheet("")
        self.lblVolt.setText("")
        self.lblVolt.setAlignment(QtCore.Qt.AlignCenter)
        self.lblVolt.setObjectName("lblVolt")
        self.KayitOl = QtWidgets.QPushButton(self.centralwidget)
        self.KayitOl.setGeometry(QtCore.QRect(410, 70, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(-1)
        font.setUnderline(False)
        ...
        self.KayitOl.setStyleSheet("QPushButton {\n"
"  background: #064570;\n"
"  background-image: -webkit-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: -moz-linear-gradient(top, #064570, #68b6e6);\n"
"  background-image: -ms-linear-gradient(top, #064570, #68b6e6);\n"
...
"  background: #3498db;\n"
"  padding: 9px 20px 10px 20px;\n"
"  border: solid #32f00c 1px;\n"
"  text-decoration: none;\n"
"}\n"
"\n"
"QPushButton:hover {\n"
"  background: #25fa33;\n"
"  background-image: -webkit-linear-gradient(top, #25fa33, #4af511);\n"
"  background-image: -moz-linear-gradient(top, #25fa33, #4af511);\n"
"  background-image: -ms-linear-gradient(top, #25fa33, #4af511);\n"
"  background-image: -o-linear-gradient(top, #25fa33, #4af511);\n"
"  background-image: linear-gradient(to bottom, #25fa33, #4af511);\n"
"  text-decoration: none;\n"
"}")
        self.KayitOl.setObjectName("KayitOl")
        self.LblSif = QtWidgets.QLabel(self.centralwidget)
        self.LblSif.setGeometry(QtCore.QRect(10, 30, 251, 31))
        font = QtGui.QFont()
        ...
        font.setWeight(50)
        self.LblSif.setFont(font)
        self.LblSif.setStyleSheet("font: 8pt \"Calibri\";\n"
"font: 22pt \"MS Shell Dlg 2\";")
        self.LblSif.setObjectName("LblSif")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(10, 270, 211, 51))
        font = QtGui.QFont()
        ...
        self.ProGir = QtWidgets.QAction(MainWindow)
        self.ProGir.setObjectName("ProGir")
        self.ProHak = QtWidgets.QAction(MainWindow)
        self.ProHak.setObjectName("ProHak")
        self.ProCik = QtWidgets.QAction(MainWindow)
        self.ProCik.setObjectName("ProCik")
        self.ProAy = QtWidgets.QAction(MainWindow)
        self.ProAy.setObjectName("ProAy")
        self.menuProgram.addAction(self.ProHak)
        self.menuProgram.addAction(self.ProCik)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Seri Port Okuyucu"))
        self.portac.setText(_translate("MainWindow", "Port Aç"))
        self.portkapat.setText(_translate("MainWindow", "Port Kapat"))
        self.baud.setText(_translate("MainWindow", "Baud Rate"))
        self.portseciniz.setText(_translate("MainWindow", "Port"))
        self.port.setCurrentText(_translate("MainWindow", "COM1"))
        ...
        self.baudrate.setItemText(0, _translate("MainWindow", "50"))
        self.baudrate.setItemText(1, _translate("MainWindow", "75"))
        self.baudrate.setItemText(2, _translate("MainWindow", "110"))
        self.baudrate.setItemText(3, _translate("MainWindow", "134"))
        self.baudrate.setItemText(4, _translate("MainWindow", "150"))
        self.baudrate.setItemText(5, _translate("MainWindow", "200"))
        self.baudrate.setItemText(6, _translate("MainWindow", "300"))
        self.baudrate.setItemText(7, _translate("MainWindow", "600"))
        self.baudrate.setItemText(8, _translate("MainWindow", "1200"))
        self.baudrate.setItemText(9, _translate("MainWindow", "1800"))
        self.baudrate.setItemText(10, _translate("MainWindow", "2400"))
        self.baudrate.setItemText(11, _translate("MainWindow", "4800"))
        self.baudrate.setItemText(12, _translate("MainWindow", "9600"))
        self.baudrate.setItemText(13, _translate("MainWindow", "19200"))
        self.baudrate.setItemText(14, _translate("MainWindow", "38400"))
        self.baudrate.setItemText(15, _translate("MainWindow", "57600"))
        self.baudrate.setItemText(16, _translate("MainWindow", "115200"))
        self.ayarlar.setText(_translate("MainWindow", "AYARLAR"))
        self.pb_cikis.setText(_translate("MainWindow", "ÇIKIŞ"))
        self.KayitOl.setText(_translate("MainWindow", "Yeni Kullanıcı"))
        self.LblSif.setText(_translate("MainWindow", "Seri Port Okuyucu"))
        self.label_10.setText(_translate("MainWindow", "TextLabel"))
        self.menuProgram.setTitle(_translate("MainWindow", "Program"))
        self.ProGir.setText(_translate("MainWindow", "Giriş"))
        self.ProHak.setText(_translate("MainWindow", "Hakkında"))
        self.ProCik.setText(_translate("MainWindow", "Çıkış"))
        self.ProAy.setText(_translate("MainWindow", "Ayarlar"))
