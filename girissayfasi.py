...
class Ui_girispenceresi(object):
    def setupUi(self, girispenceresi):
        ...
        girispenceresi.resize(313, 260)
        girispenceresi.setMinimumSize(QtCore.QSize(313, 260))
        girispenceresi.setMaximumSize(QtCore.QSize(313, 260))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("qrc/indir (1).jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        girispenceresi.setWindowIcon(icon)
        girispenceresi.setStyleSheet("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}")
        ...
        self.checkBox.setGeometry(QtCore.QRect(160, 80, 147, 20))
        self.checkBox.setStyleSheet("")
        self.checkBox.setObjectName("checkBox")
        self.GrsG = QtWidgets.QPushButton(self.centralwidget)
        self.GrsG.setGeometry(QtCore.QRect(10, 120, 131, 61))
        self.GrsG.setStyleSheet("QPushButton {\n"
"  background: #064570;\n"
...
"}\n"
"")
        self.GrsG.setObjectName("GrsG")
        self.pb_cikis = QtWidgets.QPushButton(self.centralwidget)
        self.pb_cikis.setGeometry(QtCore.QRect(170, 120, 131, 61))
        font = QtGui.QFont()
...
"}")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 285, 58))
        ...
        self.LblKul = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        ...
        self.horizontalLayout_2.addWidget(self.LblSif)
        ...
        self.ProKay = QtWidgets.QAction(girispenceresi)
        self.ProKay.setObjectName("ProKay")
        self.ProHak = QtWidgets.QAction(girispenceresi)
        self.ProHak.setObjectName("ProHak")
        self.ProCik = QtWidgets.QAction(girispenceresi)
        self.ProCik.setObjectName("ProCik")
        self.ProKay_3 = QtWidgets.QAction(girispenceresi)
        self.ProKay_3.setObjectName("ProKay_3")
        self.menuProgram.addAction(self.ProKay)
    ...
    def retranslateUi(self, girispenceresi):
        ...
        self.GrsG.setText(_translate("girispenceresi", "Giriş"))
        self.pb_cikis.setText(_translate("girispenceresi", "ÇIKIŞ"))
        self.LblKul.setText(_translate("girispenceresi", "Kullanıcı Adı:"))
        self.LblSif.setText(_translate("girispenceresi", "Şifre :"))
        self.Sifre.setText(_translate("girispenceresi", "Sifre"))
        self.menuProgram.setTitle(_translate("girispenceresi", "Program"))
        self.actionGiri.setText(_translate("girispenceresi", "Giriş"))
        self.ProKay.setText(_translate("girispenceresi", "Kayıt Ol"))
        self.ProHak.setText(_translate("girispenceresi", "Hakkında"))
        self.ProCik.setText(_translate("girispenceresi", "Çıkış"))
        self.ProKay_3.setText(_translate("girispenceresi", "Kayıt Ol"))
